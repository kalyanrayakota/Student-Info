...
public class Add extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setPreferredSize(new java.awt.Dimension(150, 34));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(course, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(225, 225, 225)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            try {
             ...
             con = DriverManager.getConnection("jdbc:ucanaccess://C:\\Users\\User\\Desktop\\Database.accdb");
             s =con.createStatement();
             con.setAutoCommit(false);
            String query = "insert into Database(SName,Address,ID,Email,Course) "
            + "VALUES ('"+name.getText()+"', '"+address.getText()+"', '"+id.getText()+"', "
                    + "'"+email.getText()+"', '"+course.getText()+"')";
            ...
            course.setText(null);
                ...
                ps = con.prepareStatement("insert into Database(SName,Address,ID,Email,Course)values(?,?,?,?,?)") ;
